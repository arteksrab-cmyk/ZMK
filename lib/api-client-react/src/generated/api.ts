...
export const getSubmitLeadMutationKey = () => ['submitLead'] as const;

export const getSubmitLeadMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof submitLead>>, TError,SubmitLeadMutationVariables, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof submitLead>>, TError,SubmitLeadMutationVariables, TContext> => {

const mutationKey = getSubmitLeadMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof submitLead>>, SubmitLeadMutationVariables> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SubmitLeadMutationBody = BodyType<LeadSubmissionInput>
    export type SubmitLeadMutationError = ErrorType<ErrorResponse>
    export type SubmitLeadMutationVariables = {data: BodyType<LeadSubmissionInput>}
